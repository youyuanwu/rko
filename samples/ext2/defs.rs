...
// SAFETY: Super is a plain repr(C) struct matching the on-disk layout.
unsafe impl rko_core::types::FromBytes for Super {}
...
// SAFETY: Group is a plain repr(C) struct.
unsafe impl rko_core::types::FromBytes for Group {}
...
// SAFETY: INode is a plain repr(C) struct.
unsafe impl rko_core::types::FromBytes for INode {}
...
// SAFETY: DirEntry is a plain repr(C) struct.
unsafe impl rko_core::types::FromBytes for DirEntry {}

...
// SAFETY: All fields are integers or LE<integer>, valid for any bit pattern.
...
// SAFETY: All fields are LE<u64>, valid for any bit pattern.
unsafe impl rko_core::types::FromBytes for Header {}

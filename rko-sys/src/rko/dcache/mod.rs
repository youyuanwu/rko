...
#[cfg(all(feature = "fs", feature = "types"))]
windows_link::link!("kernel" "C" fn d_alloc_parallel(param0 : *mut dentry, param1 : *const qstr, param2 : *mut super::fs:: wait_queue_head) -> *mut dentry);
#[cfg(all(feature = "fs", feature = "types"))]
...
pub union dentry__anon_1 {
    ...
    pub d_wait: *mut super::fs::wait_queue_head,
}
#[cfg(all(feature = "fs", feature = "types"))]
